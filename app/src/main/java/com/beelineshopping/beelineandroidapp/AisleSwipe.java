...
public class AisleSwipe extends AppCompatActivity {
    Context mContext;
    public static ArrayList<String> aisle_list = new ArrayList<String>();
    public static BeelineDbHelper mDbHelper;
    public static SQLiteDatabase db;
    public static String crStr;
    /**
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            //textView.setText(getString( getArguments().getString(ARG_SECTION_NUMBER)));
            textView.setText(getArguments().getString(ARG_SECTION_NUMBER));
            Context mContext = container.getContext();
            DatabaseUtils dbUtils =  new DatabaseUtils();
            //AisleAdapter list1Adapter = new AisleAdapter(this,list1Cursor,0);
            mDbHelper = new BeelineDbHelper(mContext);
            db = mDbHelper.getReadableDatabase();
            String whereClause = "ShoppingList.list_title = \'Example List\'";
            Cursor c = db.query(BeelineContract.ShoppingListDetails.TABLE_NAME, null,
...
//            }
            ...
            AisleAdapter aaList1 = new AisleAdapter(mContext,c,0);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public SectionsPagerAdapter(FragmentManager fm) {
            super(fm);
            //todo create countAisles() function
            //aislesToArray();
        }
        ...
        public Fragment getItem(int position) {
            ...
            return PlaceholderFragment.newInstance(atest);
        }
    ...
    private void aislesToArray(){
        ...
        crStr = dbUtils.dumpCursorToString(c);
        String aisleName;
        c.moveToFirst();
        for(int i = 0; i < c.getCount(); i++){
            aisleName = c.getString(c.getColumnIndex("aisle"));
